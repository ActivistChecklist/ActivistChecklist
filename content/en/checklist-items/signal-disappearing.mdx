...
<HowTo title="How to enable disappearing messages">
  1) **To change the default:** <MenuPath inline>Signal > Profile picture > **Settings** > **Privacy** > **Disappearing Messages** > set to your desired time (longer or shorter depending on your risk tolerance)</MenuPath>.
  2) **(Android-only) Change your message retention limit:** This will delete messages on threads even that don't have disappearing messages turned on. (They will only be deleted on your device.) <MenuPath inline>Signal > Profile picture > **Data and storage** > **Manage storage** > **Keep Messages** > set to your desired max timeframe</MenuPath>. Go back a screen and enable **Apply limits to linked devices**.
