...
seoDescription: Set up a second phone for protests and organizing so a seized device exposes less. Step-by-step setup, about $60 plus $15 per month, 3 hours.
answerCapsule: >
  A secondary phone is a low-data device you use for protests and
  organizing. Goal is harm reduction, not full anonymity. Buy a used
  Android or cheap phone, a prepaid SIM in cash, register Apple or
  Google with a Proton Mail address, install Signal, and clear data
  after each action. Expect roughly $60 to start plus $15 per month.
