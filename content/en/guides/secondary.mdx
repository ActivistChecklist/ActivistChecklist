...
answerCapsule: >
  A secondary phone is a low-data device you bring to protests and use
  for sensitive organizing. The goal is harm reduction, not anonymity.
  Buy a cheap unlocked phone (iPhone or Android works) or repurpose a
  spare, get a prepaid SIM in cash from a store, register the Apple or
  Google account with a fresh Proton Mail address, install Signal, and
  clear data after each action.
