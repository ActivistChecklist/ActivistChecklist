...
We maintain a warrant canary to attest that we have not been compelled to modify the site or received any legal demand for user data that we were prohibited from disclosing. 

[View our warrant canary →](/files/canary.txt)

We will update this canary every 3 months. If more than 4 months pass without an update AND we are still regularly updating our [code respository](https://github.com/ActivistChecklist/ActivistChecklist), that is a sign to ask questions rather than a confirmed compromise. Start by [contacting](/contact/) us to see if we're just behind on an update.
