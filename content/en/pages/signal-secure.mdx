...
answerCapsule: >
  Yes, Signal is secure for activist organizing. It's end-to-end
  encrypted, the code is open source and audited. When law enforcement
  subpoenas Signal, they get the account creation date and last
  connection date. They cannot get message contents or your contact
  list. The remaining risk is your device: a seized phone with a weak
  passcode exposes everything, regardless of how strong Signal itself is.
relatedGuides:
  - signal
  - essentials
