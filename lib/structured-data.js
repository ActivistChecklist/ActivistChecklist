 ...
 * and markdown so it can serve as a HowToStep `text` field.
 *
 ...
 * our own MDX (trusted at build time), but the looped form is defense in
 * depth and satisfies CodeQL's "incomplete multi-character sanitization"
 * check. The output is also re-encoded via serializeJsonLd before reaching
 * any HTML context.
 */
