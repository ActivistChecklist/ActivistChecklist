...
const USE_DEFAULT_OG_IMAGE = [
  ...
  'checklists',
  'flyer',
  // /tools/ is an app route, not MDX, so the OG generator (which walks guides +
  // pages) never renders a card for it. Without this the page would point at an
  // /images/og/tools.png that is never built.
  'tools',
];
