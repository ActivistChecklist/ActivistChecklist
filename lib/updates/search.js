 ...
 *
 * Result limit is generous (defaults to 30) so a broad query like "ipad" surfaces every
 * iPad rather than capping at 8. The dropdown scrolls.
 */
export function searchIndex(rows, fuse, query, priorityProductIds, { limit = 30 } = {}) {
