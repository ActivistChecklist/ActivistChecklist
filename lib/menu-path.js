...
/**
 * Split a text run on " > " separators (whitespace-flanked chevrons), so a
 * standalone ">" inside other prose isn't treated as a step boundary.
 * Returns the segments; the caller inserts an arrow between consecutive ones.
 */
