...
const ChangeLogTimelineMarker = ({ type }) => {
      ...
      <TooltipProvider delayDuration={0}>
        <Tooltip>
          <TooltipTrigger asChild>
            <div className="absolute z-20 inset-s-6 top-[12px] w-5 h-5 -translate-x-1/2 rtl:translate-x-1/2 flex items-center justify-center">
  ...
  return (
    <div className="absolute z-20 inset-s-6 top-[18px] w-2 h-2 bg-primary rounded-full -translate-x-1/2 rtl:translate-x-1/2"></div>
  );
};
